...
//	 JSONObject[] object = new JSONObject[18];
	 
//	 public List Dicide_lowOfKjinteraction (Survey_data Kjinteractioncity, JSONObject[] object) {
//	 
//		 Survey_data survey_data = new Survey_data();
//		 object[0] = new JSONObject();
////		 object[0].put("Gyeonggi-do", +'" + survey_data.getGyeonggi_people() + "');
//		 
//		 
//		 List List = null;
//		return List;
